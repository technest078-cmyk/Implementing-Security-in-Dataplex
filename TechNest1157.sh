...
gcloud dataplex lakes create customer-info-lake --location=$REGION --display-name="TechNest Info Lake"

gcloud dataplex zones create customer-raw-zone --location=$REGION --display-name="TechNest Raw Zone" --lake=customer-info-lake --type=RAW --resource-location-type=SINGLE_REGION

gcloud dataplex assets create customer-online-sessions \
  --location=$REGION \
  --display-name="Technest Online Sessions" \
